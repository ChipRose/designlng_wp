        ...
        <div class="reviews feedback__form-block">
          <div class="review feedback__review">
            <div class="review__image-wrapper">
              <picture><img class="review__image" src="<?php bloginfo("template_url");?>/assets/img/avatar/ivan.png" srcset="<?php bloginfo("template_url");?>/assets/img/avatar/ivan@2x.png 2x" width="50" height="50" alt="Аватар Ивана Грачева" /></picture>
            </div>
          ...
          <div class="review feedback__review">
            <div class="review__image-wrapper">
              <picture><img class="review__image" src="<?php bloginfo("template_url");?>/assets/img/avatar/maria.png" srcset="<?php bloginfo("template_url");?>/assets/img/avatar/maria@2x.png 2x" width="50" height="50" alt="Аватар Марии Рачинской" /></picture>
            </div>
          ...
          <div class="review feedback__review">
            <div class="review__image-wrapper">
              <picture><img class="review__image" src="<?php bloginfo("template_url");?>/assets/img/avatar/svetlana.jpg" srcset="<?php bloginfo("template_url");?>/assets/img/avatar/svetlana@2x.jpg 2x" width="50" height="50" alt="Аватар Светланы" /></picture>
            </div>
